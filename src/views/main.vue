  ...
  <div>
    <div class="pt-2 d-flex">
      <div class="w-50 mr-lg-10">
        ...
        <div>
          <v-card v-for="(oneCase, index) in cases.splice(0,3)" :key="index" class="caso ma-5 rounded-lg">
            <v-card-title>
              <h3>
                {{ oneCase.title}}<span class="text-green-lighten-1">{{ oneCase.condition }}</span>
              </h3>
            </v-card-title>
            <v-card-text>
              <p>
            ...
            <v-card-actions class="justify-end mr-10 mb-2">
              <router-link class="text-decoration-none text-black" :to="`/micaso/${oneCase.id}`"
      ...
      <div class="w-50 ml-lg-10">
        <h2 class="text-center">Mi Abogado</h2>
        <v-img
        ...
        <div>
          <v-card v-for="(oneNotification, i) in notifications.splice(0,2)" :key="i" class="caso ma-5 rounded-lg">
            <v-card-title>
